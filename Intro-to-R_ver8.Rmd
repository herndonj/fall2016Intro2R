...
* [RStudio in the Duke Cloud](https://vm-manage.oit.duke.edu/containers/rstudio).  Duke manages a cloud version of RStudio for you, you don't have to install anything.  RAM is limited to 2GB.  You can easily install R and [RStuido](https://www.rstudio.com/) on your own workstation.  These tools are free.
