...
library(rmarkdown)  # R specific implementation of markdown.  helpful in generating an HTML output document - https://github.com/hadley/rmarkdown
...
For now, remember you can only store one data type in a Vector *but* you can store multiple vector types in a data frame.  I encourage you to read more about Data Types, later.  Because many R road blocks occur when the R programmer is misunderstanding the data structure of a particular data object.  On the other hand, if you're working with statistics, this level of atomization brings critical and useful functionality.
...
### Steps
1. Download the sample [UnempData.csv](https://ndownloader.figshare.com/files/5909145?private_link=50e77f2201ac90141e4c) file to a  directory on your local workstation.
