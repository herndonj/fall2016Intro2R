...
## Identify descriptive characteristics of data objects
...
four.six <- rename(four.six, make = `rownames(mtcars)`)     #rename the auto-named added column
four.six <- select(four.six, make, mpg:wt)                  #select the columns wanted
...
# Joel:  How do I split on the four.six$make vector.  I want to split on the space and take the first element for make; second element for model.  basically:  value.split(" ")[0] 
