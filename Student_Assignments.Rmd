...
1. Using what we've you've seen in class, if `westUnion.txt` is a csv file, how would you load the file into a new variable called `westUnion`?
...
3. Take a look at the structure of the `westUnion` variable.
    ...
    - How many indicators (columns) are there?
    - How many of the columns are numeric data?
...
4. The head of Duke dining is considering reducing prices at the West Union. Using what we've learned in class, write a line of code that will calculate a new variable that contains items at half price.
